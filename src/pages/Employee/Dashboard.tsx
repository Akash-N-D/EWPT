            ...
            <Card>
              ...
              <CardContent>
                <form className="space-y-4" onSubmit={handleSubmitReport}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label htmlFor="project" className="text-sm font-medium">Task</label>
                      <select 
                        id="project" 
                  ...
                  <div className="space-y-2">
                    <label htmlFor="clientFeedback" className="text-sm font-medium">Difficulties Faced / Need Support</label>
                    <Textarea 
                      id="clientFeedback" 
                      rows={3}
                      placeholder="Enter any difficulties faced..."
                  ...
                  <div className="space-y-2">
                    <label htmlFor="hours" className="text-sm font-medium">Number of days needed to complete the Task</label>
                    <Input 
                      type="number" 
                      id="hours" 
